...
namespace EasyCharacterMovement
{
    ...
    public class Character : MonoBehaviour
    {
        ...
        {
            characterMovement.RotateTowards(worldDirection, rotationRate * Time.fixedDeltaTime, isPlanar);
        }
        ...
        public virtual void RotateTowardsWithSlerp(Vector3 worldDirection, bool isPlanar = true)
        {
            ...
            characterMovement.rotation =
                Quaternion.Slerp(characterMovement.rotation, targetRotation, rotationRate * Mathf.Deg2Rad * Time.fixedDeltaTime);
        }
